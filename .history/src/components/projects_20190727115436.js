  ...
  toggleCategories() {
    ...
    if(this.state.activeTab === 0){
        ...
        <div className="projects-grid">
          ...
          <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
            <CardTitle style={{color: '#fff', height: '176px', background: 'center / cover'}} >
              <img src={project3} alt='' style={{ width: '30%', margin: '10px', borderRadius: '5px' }} />
            </CardTitle>
            <CardText>
            </CardText>
            <CardActions border>
      ...
      return (
        <div className="projects-grid">
          {/* Project 1 */}
          <Card shadow={5} style={{ minWidth: '450', margin: 'auto', width: '40%', paddingBottom: '20px' }}>
            <CardTitle style={{ color: '#fff', height: '176px' }} >
              <img src={trim} alt='' style={{ width: '30%', margin: '10px', borderRadius: '5px' }} />
              <img src={trim} alt='' style={{ width: '30%', margin: '10px', borderRadius: '5px' }} />
              <img src={trim} alt='' style={{ width: '30%', margin: '10px', borderRadius: '5px' }} />
            </CardTitle>
            <CardText>
          ...
          {/* Project 2 */}
          <Card shadow={5} style={{ minWidth: '450', margin: '5', width: '50%', paddingBottom: '20px' }}>
            <CardTitle style={{ color: '#fff', height: '176px' }} >
              <img src={uflix} alt='' style={{ width: '30%', margin: '10px', borderRadius: '5px' }} />
              <img src={uflix} alt='' style={{ width: '30%', margin: '10px', borderRadius: '5px' }} />
              <img src={uflix} alt='' style={{ width: '30%', margin: '10px', borderRadius: '5px' }} />
            </CardTitle>
            <CardText>
            ...
            <CardActions border style={{marginTop: '50px', display: 'flex', justifyContent: 'space-between', flexDirection: 'row'}}>
              ...
              <Button colored><a href='https://mudassir-auth093.firebaseapp.com/' target='_blank' rel="noopener noreferrer">APK</a></Button>
            </CardActions>
            <CardMenu style={{ color: '#fff' }}>
              <IconButton name="share" />
            </CardMenu>
