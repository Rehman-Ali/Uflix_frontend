        ...
        <Grid className="contact-grid">
          <Cell col={6}>
            ...
            <img
             ...
             I am a full MERN Stack developer having 1 + years of experience in both front-end (ReactJs, React Native) and back-end (NodeJs, expressJs ) server side technologies by using Sqlite databases and NoSql databases (mongodb).
