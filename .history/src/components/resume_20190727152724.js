      ...
      <div>
        <Grid>
          <Cell col={4}>
            ...
            <p>
              I am a full MERN Stack developer with extensive experience in both front-end (ReactJs, React Native) and back-end (NodeJs, expressJs, ) server side technologies by using both sqlite databases and NoSql databases (mongodb).
   ...
   I provides effective, bug-free apps.
          ...
          <Cell className="resume-right-col" col={8}>
            ...
            <Experience
              ...
              jobDescription="I am currently working there as a MERN Stack Developer and developing both web & hybrid mobile apps "
            />
