...
import trim2 from '../images/trim-2.jpg';
  ...
  toggleCategories() {
    ...
    if(this.state.activeTab === 0){
      ...
      return (
        <div className="projects-grid">
          {/* Project 1 */}
          <Card shadow={5} style={{ minWidth: '450', margin: 'auto', width: '45%', backgroundColor: 'yellow', paddingBottom: '20px' }}>
            <CardTitle style={{ color: '#fff', height: '176px' }} >
          ...
          {/* Project 2 */}
          <Card shadow={5} style={{ minWidth: '450', margin: '5', width: '45%', backgroundColor: '#261010', paddingBottom: '20px' }}>
            <CardTitle style={{ color: '#fff', height: '176px' }} >
